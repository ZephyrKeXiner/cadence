...
enum MatmulTest {
    ...
    static func run() {
        ...
        let result = graph.run(with: commandQueue, feeds: [aPlaceholder: aTensorData, bPlaceholder: bTensorData], targetTensors: [cTensor], targetOperations: nil)
    ...
    static func readFloats(from tensorData: MPSGraphTensorData,
                           count: Int) -> [Float] {
    ...
    static func cpuMatmul(a: [Float], b: [Float],
